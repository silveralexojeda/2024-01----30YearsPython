...
import time
wait_time = 3 #ESPEPRA 3 SEGUNDO
time.sleep(wait_time)


#A boolean data type represents one of the two values: True or False. 
#The use of these data types will be clear once we start using the comparison 
#operator. The first letter T for True and F for False should be capital unlike 
#JavaScript. Example: Boolean Values
